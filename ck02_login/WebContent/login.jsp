...
<script type="text/javascript">
	function changeImg(){
		document.getElementById("img1").src="/ck02_login/CheckImgServlet?time="+new Date().getTime();
	}
</script>
</head>
<body>
...
<form action="/ck02_login/LoginServlet" method="post">
	<table border="1" width="500">
		...
		<tr>
			...
			<img id="img1" src="/ck02_login/CheckImgServlet"/>
